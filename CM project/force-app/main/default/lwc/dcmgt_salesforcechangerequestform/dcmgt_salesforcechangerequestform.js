...
import storeStageData from '@salesforce/apex/dcmgt_salesforceCRFController.storeStageRecord'
import getMapOfUserIdAndName from '@salesforce/apex/dcmgt_salesforceCRFController.getMapOfUserIdAndName'
import getTemplateFields from '@salesforce/apex/dcmgt_salesforceCRFController.getTemplateFields'
import getAllDataAsserts from '@salesforce/apex/dcmgt_salesforceCRFController.getAllDataAsserts'
import getArticleByGlossary from '@salesforce/apexContinuation/dcmgt_salesforceCRFController.getArticleByGlossary'
import getDataAssertByDictionary from '@salesforce/apexContinuation/dcmgt_salesforceCRFController.getDataAssertByDictionary'

import getListOfDataAssetsByDictionaryId  from '@salesforce/apex/dcmgt_salesforceCRFController.getListOfDataAssetsByDictionaryId';
import getAlationArticleDataByGlossaryId from '@salesforce/apex/dcmgt_salesforceCRFController.getAlationArticleDataByGlossaryId';
import {ShowToastEvent} from 'lightning/platformShowToastEvent';
import {getRecord,getFieldDisplayValue} from 'lightning/uiRecordApi'
import Id from '@salesforce/user/Id'
import NAME_FIELD from '@salesforce/schema/User.Name'
import getRequestName from '@salesforce/apex/dcmgt_salesforceCRFController.getRequestTypeName'
...
export default class dcmgt_salesforcechangerequestform extends LightningElement {
    ...
    //                     Obj['Alation Article'] = children[0].title
    //                 } else {
    ...
    //                 return {...user, options : this.usersOptions }
    //             } else {
    //                 return {...user}
    //             }
    //         }) 
...
//    }
        ...
        // } else {
            ...
            let isRequiredFieldsMissing = this.tableJSONData.some(data => {
                if((this.isDataDictionary &&
                    (! data['dcmgt_Service_Owners__c'] 
                    || !data['dcmgt_Data_Stewards__c'])) ||
                    (this.isGlossary &&
                    (!data['dcmgt_DataStewards__c'] 
                    || !data['dcmgt_Data_Owners__c']))) {
    ...
    saveStageData() {
        ...
        .then(data => {
            ...
            this.isLoading = false
            console.log('saveStageData error', error)
        })
    }
